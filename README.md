...
1. Generically store and retrieve multiple app credentials in a single JSON object via the [`credentials`](https://pkg.go.dev/github.com/grokify/goauth/credentials) package. Supports both OAuth 2 and JWT.
